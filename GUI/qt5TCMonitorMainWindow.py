...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton = QtWidgets.QPushButton(self.tabMemory)
        ...
        self.tablewMemoryOverview.setColumnCount(8)
        ...
        self.hlayout2Bottom.addLayout(self.verticalLayout)
