...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableDmesgList = QtWidgets.QTableWidget(self.tabLogger)
        self.tableDmesgList.setGeometry(QtCore.QRect(10, 70, 1081, 681))
        ...
        self.btnLoadDmesg = QtWidgets.QPushButton(self.tabLogger)
        self.btnLoadDmesg.setGeometry(QtCore.QRect(90, 30, 75, 23))
        self.btnLoadDmesg.setObjectName("btnLoadDmesg")
        self.tabWidget.addTab(self.tabLogger, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.tableJournalList = QtWidgets.QTableWidget(self.tab_4)
        self.tableJournalList.setGeometry(QtCore.QRect(10, 70, 1081, 681))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnLoadJournal = QtWidgets.QPushButton(self.tab_4)
        self.btnLoadJournal.setGeometry(QtCore.QRect(90, 30, 75, 23))
