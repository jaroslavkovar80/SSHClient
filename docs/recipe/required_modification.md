...
   -> **RecipeDialog_NewMachConfig.content** and **RecipeDialog_EditMachConfig.content** are used to create and edit  **machine settings recipes**. Both use a **ContentControl                widget** reusing **RecipeMachConfig.content**, therefore all settings, labels, and bindings are the same. The visibility of **Edit inputs** versus **Preview and Active outputs** is                controlled through behavior inputs of the compound widget. 
