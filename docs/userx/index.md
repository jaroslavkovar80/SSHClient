...
This section describes the **mapp UserX Framework 6**. For full details on **mapp UserX** itself, see [here](https://help.br-automation.com/#/en/4/mapptechnology/mapp_services/mpuserx/mpuserx.html).
